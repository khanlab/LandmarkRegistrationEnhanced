...
#
# LandmarkRegistrationEnhanced
#

class LandmarkRegistrationEnhanced:
  def __init__(self, parent):
    parent.title = "Landmark Registration Enhanced"
    parent.categories = ["Registration"]
    parent.dependencies = []
    parent.contributors = ["Robarts Research Institute"] # replace with "Firstname Lastname (Org)"
    ...
    try:
      ...
      slicer.selfTests = {}
    slicer.selfTests['LandmarkRegistrationEnhanced'] = self.runTest

  def runTest(self):
    tester = LandmarkRegistrationEnhancedTest()
    tester.runTest()
...
class LandmarkRegistrationEnhancedWidget:
  ...
  def setup(self):
    ...
    if self.developerMode:
      ...
      self.reloadButton.name = "LandmarkRegistrationEnhanced Reload"
  ...
  def onReload(self,moduleName="LandmarkRegistrationEnhanced"):
    """Generic reload method for any scripted module.
    ModuleWizard will subsitute correct default moduleName.
    Note: customized for use in LandmarkRegistrationEnhanced
    """
  ...
  def onReloadAndTest(self,moduleName="LandmarkRegistrationEnhanced",scenario=None):
    try:
      self.onReload()
